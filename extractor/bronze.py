...
TABLE_SPECS: tuple[TableSpec, ...] = (
    ...
    TableSpec("T_CANCEL_CNOTE_API", "t_cancel_cnote_api", Stage.CNOTE, "API_CNOTE_NO", "CNOTE", "CREATE_DATE"),
    ...
    TableSpec("CMS_MHOV_RSHEET", "cms_mhov_rsheet", Stage.CNOTE, "MHOV_RSHEET_NO", "HOV_RSHEET", "CREATE_DATE"),
    ...
    TableSpec("CMS_MRSHEET_PRA", "cms_mrsheet_pra", Stage.CNOTE, "MRSHEET_NO", "DRSHEET_PRA", "MRSHEET_DATE"),
    ...
    TableSpec("CMS_MSTATUS", "cms_mstatus", Stage.RUNSHEET_DO, "MSTATUS_NO", "DSTATUS", "CREATE_DATE"),
...
{cnote_query}
    ...
    jobs = {
        ...
        "HOV_RSHEET": ScopeJob(
            "HOV_RSHEET",
            settings.table("HOV_RSHEET"),
            "HOV_RSHEET_NO",
            _scope_join_query(f"{src}.CMS_DHOV_RSHEET", "src", "src.DHOV_RSHEET_NO AS HOV_RSHEET_NO", cnote_scope, "scope", "DHOV_RSHEET_CNOTE", "CNOTE_NO"),
        ),
        "DHOUNDEL": ScopeJob(
            "DHOUNDEL",
        ...
        "DRSHEET_PRA": ScopeJob(
            "DRSHEET_PRA",
            settings.table("DRSHEET_PRA"),
            "DRSHEET_NO",
            _scope_join_query(
                f"{src}.CMS_DRSHEET_PRA",
                "src",
                "src.DRSHEET_NO",
                cnote_scope,
                "scope",
                "DRSHEET_CNOTE_NO",
                "CNOTE_NO",
                _scope_date_filter("src", "CREATION_DATE", window, date_guard_lookback_days, date_guard_lookahead_days),
            ),
        ),
        "DSTATUS": ScopeJob(
            "DSTATUS",
            settings.table("DSTATUS"),
            "DSTATUS_NO",
            _scope_join_query(f"{src}.CMS_DSTATUS", "src", "src.DSTATUS_NO", cnote_scope, "scope", "DSTATUS_CNOTE_NO", "CNOTE_NO"),
        ),
        "MANIFEST": ScopeJob(
            "MANIFEST",
...
def cleanup_scope_tables(conn: Any, settings: ScopeSettings) -> None:
    for name in (
        "MSJ", "RDSJ_HVO", "HVO", "HVI", "DSTATUS", "DRSHEET_PRA",
        "DRSHEET", "DHOUNDEL", "HOV_RSHEET", "DHI_HOC", "DRCNOTE",
        "COST_MANIFEST", "MMBAG", "SMU", "DMBAG", "MFBAG", "MANIFEST",
        "CNOTE",
    ):
...
def scope_predicate(scope: ScopeSettings, table_alias: str, scope_name: str, scope_column: str) -> str:
    key_column = {
        ...
        "DRCNOTE": "DRCNOTE_NO",
        "DHI_HOC": "DHI_NO",
        "HOV_RSHEET": "HOV_RSHEET_NO",
        "DHOUNDEL": "DHOUNDEL_NO",
        "DRSHEET": "DRSHEET_NO",
        "DRSHEET_PRA": "DRSHEET_NO",
        "DSTATUS": "DSTATUS_NO",
