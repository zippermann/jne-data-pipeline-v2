...
CATALOG: list[dict] = [
    ...
    # ------------------------------------------------------------------
    # Former skipped rows now supported by bridged and aggregate rule families.
    # ------------------------------------------------------------------
    {
        "index_code": "TIME1E7",
        "element": "Timeliness",
        ...
        "description": "MHI approval must occur before MRCNOTE sign date via DRCNOTE bridge.",
    },
    {
        "index_code": "TIME1C9",
        "element": "Timeliness",
    ...
    },
    {
        ...
        "params": {
            ...
            "joins": [
                {"table": "CMS_DRSHEET", "left_on": "MRSHEET_NO", "right_on": "DRSHEET_NO"},
                {"table": "CMS_CNOTE_POD", "left_on": "DRSHEET_CNOTE_NO", "right_on": "CNOTE_POD_NO"},
            ],
            "cnote_column": "DRSHEET_CNOTE_NO",
        },
    ...
    },
    {
        ...
        "description": "Outbound handover sign date must occur before MSJ sign date.",
    },
    {
        "index_code": "CONS2C3",
        "element": "Consistency",
        ...
        "params": {
            ...
            "joins": [
                {"table": "CMS_DRCNOTE", "left_on": "MRCNOTE_NO", "right_on": "DRCNOTE_NO"},
                {"table": "CMS_CNOTE", "left_on": "DRCNOTE_CNOTE_NO", "right_on": "CNOTE_NO"},
            ],
            "cnote_column": "DRCNOTE_CNOTE_NO",
        },
    ...
    },
    {
        ...
        "params": {
            ...
            "left_column": "COST_M_DESTINATION",
            "right_column": "CNOTE_DESTINATION",
            "joins": [
                {"table": "CMS_COST_DTRANSIT_AGEN", "left_on": "MANIFEST_NO", "right_on": "DMANIFEST_NO"},
                {"table": "CMS_CNOTE", "left_on": "CNOTE_NO", "right_on": "CNOTE_NO"},
            ],
            "cnote_column": "CNOTE_NO",
        },
    ...
    },
    {
        ...
        "params": {
            ...
            "joins": [
                ...
                {"table": "CMS_DSMU", "left_on": "DMBAG_BAG_NO", "right_on": "DSMU_BAG_NO"},
            ],
