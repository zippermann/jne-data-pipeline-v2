...
from src.governance.config import load_governance_config, table_path
from src.governance.duck import connect_duckdb
from src.governance.rules.executors import EXECUTORS, run_completeness_batch
from src.governance.rules.explain import print_explanation
from src.governance.rules.registry import active_rules
...
def run(config_path: str) -> list:
    from src.governance.output import write_outputs
